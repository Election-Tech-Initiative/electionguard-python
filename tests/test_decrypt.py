...
class TestDecrypt(unittest.TestCase):
    ...
    def test_decrypt_contest_valid_input_succeeds(self,
        ...
        result_from_nonce = decrypt_contest_with_nonce(subject, description, keypair.public_key, subject.nonce)
        ...
        for selection_description in description.ballot_selections:
            ...
            data_selection = [selection for selection in data.ballot_selections if selection.object_id == selection_description.object_id]
            ...
            if any(data_selection):
                self.assertTrue(data_selection[0].to_int() == key_selection.to_int())
                self.assertTrue(data_selection[0].to_int() == nonce_selection.to_int())
    ...
    def test_decrypt_ballot_valid_input_succeeds(self, keypair: ElGamalKeyPair):
        ...
        for description in metadata.get_contests_for(data.ballot_style):
            ...
            data_contest = [contest for contest in data.contests if contest.object_id == description.object_id][0]
